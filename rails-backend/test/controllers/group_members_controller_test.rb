...
class GroupMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_member" do
    assert_difference('GroupMember.count') do
      post group_members_url, params: { group_member: { admin: @group_member.admin, creator: @group_member.creator, group_id: @group_member.group_id, notifications: @group_member.notifications, user_id: @group_member.user_id } }
    end
  ...
  test "should update group_member" do
    patch group_member_url(@group_member), params: { group_member: { admin: @group_member.admin, creator: @group_member.creator, group_id: @group_member.group_id, notifications: @group_member.notifications, user_id: @group_member.user_id } }
