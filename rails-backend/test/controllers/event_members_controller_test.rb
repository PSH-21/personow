...
class EventMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_member" do
    assert_difference('EventMember.count') do
      post event_members_url, params: { event_member: { admin: @event_member.admin, creator: @event_member.creator, event_id: @event_member.event_id, notifications: @event_member.notifications, user_id: @event_member.user_id } }
    end
  ...
  test "should update event_member" do
    patch event_member_url(@event_member), params: { event_member: { admin: @event_member.admin, creator: @event_member.creator, event_id: @event_member.event_id, notifications: @event_member.notifications, user_id: @event_member.user_id } }
